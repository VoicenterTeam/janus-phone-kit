...
async function createSegmenter() {
  //STATE.model = bodySegmentation.SupportedModels.MediaPipeSelfieSegmentation

  return bodySegmentation.createSegmenter(bodySegmentation.SupportedModels.MediaPipeSelfieSegmentation, {
    runtime: 'mediapipe',
    modelType: 'general', //STATE.modelConfig.type
    solutionPath:
...
// TODO: use window.cancelAnimationFrame(rafId); on camera turn off
...
export async function app() {
  ...
  //STATE.model = bodySegmentation.SupportedModels.MediaPipeSelfieSegmentation
  //STATE.modelConfig = {...params.SELFIE_SEGMENTATION_CONFIG}
